            ...
            child: Column(
              children: [
                FormBuilder(
                    ...
                    initialValue: {
                      'type': args.type,
                      if (args.breed != null) 'breed' : args.breed,
                      'size': args.size,
                      'condition': args.condition,
                      'date': args.date.toDate(),
                      if(args.gender != null) 'gender' : args.gender,
                      if(args.remark != null) 'remark' : args.remark,
                    },
                    child: Column(
                      ...
                      children: [
                        FormBuilderImagePicker(
                          ...
                          decoration: InputDecoration(
                              labelText: "Pet photo"),
                          maxImages: 1,
                          placeholderImage: NetworkImage(args.pictureUrl!),
                        ),
                          ...
                          child: TextButton(
                            onPressed: () async {
                              ...
                              if (_formKey.currentState!.validate()) {
                                ...
                                submit.reference = args.reference;
                                globals.repository.updatePet(submit);
